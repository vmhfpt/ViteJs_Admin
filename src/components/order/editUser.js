...
export default function EditUser(item, reLoad){
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col mb-6">
              ...
              <input value="${item.phoneNumber}" type="text" id="phone-number-order" class="form-control" placeholder="Enter phone number">
            </div>
          </div>
          <div  class="row">
              <div class="col mb-12">
